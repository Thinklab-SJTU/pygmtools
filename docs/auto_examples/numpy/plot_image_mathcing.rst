...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_numpy_plot_image_mathcing.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_numpy_plot_image_mathcing.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    D:\Univ\pygmtools-0.3.4\examples\numpy\plot_image_mathcing.py:59: DeprecationWarning: BILINEAR is deprecated and will be removed in Pillow 10 (2023-07-01). Use Resampling.BILINEAR instead.
      img1 = img1.resize(obj_resize, resample=Image.BILINEAR)
    D:\Univ\pygmtools-0.3.4\examples\numpy\plot_image_mathcing.py:60: DeprecationWarning: BILINEAR is deprecated and will be removed in Pillow 10 (2023-07-01). Use Resampling.BILINEAR instead.
      img2 = img2.resize(obj_resize, resample=Image.BILINEAR)
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_001.png
   :alt: Image 1, Image 2
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_001.png
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_002.png
   :alt: Image 1 with Graphs, Image 2 with Graphs
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_002.png
   :class: sphx-glr-single-img
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_003.png
   :alt: Affinity Matrix (size: 100$\times$100)
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_003.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.image.AxesImage object at 0x000002B9214EC400>
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_004.png
   :alt: Image Matching Result by RRWM
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_004.png
   :class: sphx-glr-single-img
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_005.png
   :alt: Image Matching Result by IPFP
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_005.png
   :class: sphx-glr-single-img
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_006.png
   :alt: Image Matching Result by SM
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_006.png
   :class: sphx-glr-single-img
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_007.png
   :alt: Image Matching Result by NGM (willow pretrain)
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_007.png
   :class: sphx-glr-single-img
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_008.png
   :alt: Image Matching Result by NGM (voc pretrain)
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_image_mathcing_008.png
   :class: sphx-glr-single-img
...
.. _sphx_glr_download_auto_examples_numpy_plot_image_mathcing.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-python
      ...
      :download:`Download Python source code: plot_image_mathcing.py <plot_image_mathcing.py>`

    .. container:: sphx-glr-download sphx-glr-download-jupyter

      :download:`Download Jupyter notebook: plot_image_mathcing.ipynb <plot_image_mathcing.ipynb>`
