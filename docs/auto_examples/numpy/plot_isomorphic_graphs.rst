...
.. "auto_examples\numpy\plot_isomorphic_graphs.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_numpy_plot_isomorphic_graphs.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_numpy_plot_isomorphic_graphs.py:
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_001.png
   :alt: Graph 1, Graph 2
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_001.png
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_002.png
   :alt: Affinity Matrix (size: 100$\times$100)
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_002.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.image.AxesImage object at 0x000002B91F1ED940>
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_003.png
   :alt: RRWM Soft Matching Matrix, Ground Truth Matching Matrix
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_003.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.image.AxesImage object at 0x000002B91EC3C640>
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_004.png
   :alt: RRWM Matching Matrix (acc=1.00), Ground Truth Matching Matrix
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_004.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.image.AxesImage object at 0x000002B920308BB0>
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_005.png
   :alt: Graph 1, Graph 2
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_005.png
   :class: sphx-glr-single-img
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_006.png
   :alt: Graph 1, Aligned Graph 2
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_006.png
   :class: sphx-glr-single-img
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_007.png
   :alt: IPFP Matching Matrix (acc=1.00), Ground Truth Matching Matrix
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_007.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.image.AxesImage object at 0x000002B920994820>
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_008.png
   :alt: SM Matching Matrix (acc=1.00), Ground Truth Matching Matrix
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_008.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.image.AxesImage object at 0x000002B920B8F520>
...
.. image-sg:: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_009.png
   :alt: NGM Matching Matrix (acc=1.00), Ground Truth Matching Matrix
   :srcset: /auto_examples/numpy/images/sphx_glr_plot_isomorphic_graphs_009.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <matplotlib.image.AxesImage object at 0x000002B920DD3D60>
...
.. _sphx_glr_download_auto_examples_numpy_plot_isomorphic_graphs.py:
