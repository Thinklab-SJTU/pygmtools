...
.. "auto_examples/jittor/plot_model_fusion.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_jittor_plot_model_fusion.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_jittor_plot_model_fusion.py:
...
.. image-sg:: /auto_examples/jittor/images/sphx_glr_plot_model_fusion_001.png
   :alt: plot model fusion
   :srcset: /auto_examples/jittor/images/sphx_glr_plot_model_fusion_001.png
...
.. image-sg:: /auto_examples/jittor/images/sphx_glr_plot_model_fusion_002.png
   :alt: plot model fusion
   :srcset: /auto_examples/jittor/images/sphx_glr_plot_model_fusion_002.png
   :class: sphx-glr-single-img
...
.. image-sg:: /auto_examples/jittor/images/sphx_glr_plot_model_fusion_003.png
   :alt: Fused Model Accuracy
   :srcset: /auto_examples/jittor/images/sphx_glr_plot_model_fusion_003.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    time consumed for model fusion: 812.17 seconds
    model1 accuracy = 84.18%, model2 accuracy = 83.81%
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 13 minutes  52.150 seconds)


.. _sphx_glr_download_auto_examples_jittor_plot_model_fusion.py:
