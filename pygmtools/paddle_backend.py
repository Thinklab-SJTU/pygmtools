...
pca_gm_pretrain_path = {
    'voc': ('https://drive.google.com/u/0/uc?export=download&confirm=Z-AR&id=1PoeWfa4v3n4Bk_9VlSUSd7akZf1rL8ct',
            'https://media.githubusercontent.com/media/heatingma/pygmtools-pretrained-models-paddle-backend/main/paddle_backend/pca_gm_voc_paddle.pdparams',
    ...
    'willow': ('https://drive.google.com/u/0/uc?export=download&confirm=Z-AR&id=1hgCpvcvt5eoz1xbMbuDyBuYH6SCue6UD',
               'https://media.githubusercontent.com/media/heatingma/pygmtools-pretrained-models-paddle-backend/main/paddle_backend/pca_gm_willow_paddle.pdparams',
    ...
    'voc-all': ('https://drive.google.com/u/0/uc?export=download&confirm=Z-AR&id=116_v4rC31T-hq3kE2d_thMKmJ65swrCD',
                'https://media.githubusercontent.com/media/heatingma/pygmtools-pretrained-models-paddle-backend/main/paddle_backend/pca_gm_voc-all_paddle.pdparams',
...
ipca_gm_pretrain_path = { 
    'voc': ('https://drive.google.com/u/0/uc?export=download&confirm=Z-AR&id=1bVGl9lhhzkLeWKsjiWYHgzFV-evCo1sh',
            'https://media.githubusercontent.com/media/heatingma/pygmtools-pretrained-models-paddle-backend/main/paddle_backend/ipca_gm_voc_paddle.pdparams',
    ...
    'willow': ('https://drive.google.com/u/0/uc?export=download&confirm=Z-AR&id=17RdDzNp2SjYahRd9aep5dEbidWJNR4uu',
               'https://media.githubusercontent.com/media/heatingma/pygmtools-pretrained-models-paddle-backend/main/paddle_backend/ipca_gm_willow_paddle.pdparams',
...
cie_pretrain_path = {
    'voc': ('https://drive.google.com/u/0/uc?export=download&confirm=Z-AR&id=13dtxDfySvfqQcYvPiTd8Pb2xgcXIesAz',
            'https://media.githubusercontent.com/media/heatingma/pygmtools-pretrained-models-paddle-backend/main/paddle_backend/cie_voc_paddle.pdparams',
    ...
    'willow': ('https://drive.google.com/u/0/uc?export=download&confirm=Z-AR&id=1_-G00V3yhJ3IL_Xp6cMcVV9N2vWgEDwk',
               'https://media.githubusercontent.com/media/heatingma/pygmtools-pretrained-models-paddle-backend/main/paddle_backend/cie_willow_paddle.pdparams',
...
ngm_pretrain_path = { 
    'voc': ('https://drive.google.com/u/0/uc?export=download&confirm=Z-AR&id=1cd5AvddQtpWmENPLEWjJ76cKG7Df43nh',
            'https://media.githubusercontent.com/media/heatingma/pygmtools-pretrained-models-paddle-backend/main/paddle_backend/ngm_voc_paddle.pdparams',
    ...
    'willow': ('https://drive.google.com/u/0/uc?export=download&confirm=Z-AR&id=1j1kXWsassE3bAVWjPy2g0jUGG2IeODc8',
               'https://media.githubusercontent.com/media/heatingma/pygmtools-pretrained-models-paddle-backend/main/paddle_backend/ngm_willow_paddle.pdparams',
