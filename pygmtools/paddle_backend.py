    ...
    def __init__(self, in_channel, hidden_channel, out_channel, num_layers, cross_iter_num=-1):
        ...
        for i in range(self.gnn_layer):
            ...
            if i == self.gnn_layer - 2:  # only the second last layer will have cross-graph module
                self.add_sublayer('cross_graph_{}'.format(i), paddle.nn.Linear(hidden_channel * 2, hidden_channel))
                if cross_iter_num <= 0:
...
ngm_pretrain_path = { 
    'voc': ('https://drive.google.com/u/0/uc?export=download&confirm=Z-AR&id=1VlEkv8-RGRq8b18INSFNlTevlBWWlRyO',
            '1a927465b1d26cedaa868a736411487f'),
    'willow': ('https://drive.google.com/u/0/uc?export=download&confirm=Z-AR&id=1Xn6WZg9IpGu8lDL-ugbq4x_M1BCaL9Es',
               '292c49091d172a5bb79d5b16d779286e'),
}
